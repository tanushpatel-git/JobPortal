...
export default function Login() {
    ...
    return (<div className="min-h-screen grid place-items-center bg-gradient-to-br from-slate-50 to-slate-100 p-6">
        <ToastContainer/>
        <motion.div
        ...
        >
            <div className="bg-white shadow-xl rounded-2xl relative -top-[15vh] p-8 space-y-6">
